...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-background text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen flex-col justify-center px-6 py-24 sm:px-8 lg:px-12">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-gray-200 shadow-lg shadow-primary/10 mb-6">
          ...
          <p className="mt-6 max-w-3xl text-xl leading-9 text-gray-300 sm:text-2xl">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item.title} className="rounded-3xl border border-white/10 bg-surface/90 p-5 shadow-xl shadow-black/20">
